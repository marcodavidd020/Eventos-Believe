@php
$hour = date('H');
$theme = ($hour >= 18 || $hour < 6) ? 'dark' : 'light' ; $headers=['Id', 'Codigo' , 'Fecha' , 'Costo Entrada' , 'Cantidad', 'Costo total'
    ,'Estado','Usuario','Evento' ]; $rows=$bookings->map(function($booking) {
    return [
    'id' => $booking->id,
    'codigo' => $booking->codigo,
    'fecha' => $booking->fecha,
    'costo_entrada' => $booking->costo_entrada,
    'cantidad' => $booking->cantidad,
    'costo_total' => $booking->costo_total,
    'estado' => $booking->estado,
    'usuario' => $booking->usuario->name,
    'evento' => $booking->evento->nombre,
        ...
        <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <x-table :headers="$headers" :rows="$rows" :theme="$theme" resource="reservas" />
                </div>
            </div>
        </div>
